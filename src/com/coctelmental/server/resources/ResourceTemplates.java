...
public interface ResourceTemplates {
	...
	public static final String USER_RESOURCE_WITH_ID = "/user/{userID}/{userPasswd}";
	public static final String TAXI_RESOURCE = "/taxi";
	public static final String TAXI_RESOURCE_WITH_ID = "/taxi/{taxiDNI}/{taxiPasswd}";
	public static final String TAXI_RESOURCE_WITHOUT_PASSWORD = "/taxi/{taxiDNI}";
	public static final String BUS_RESOURCE = "/bus";
	public static final String BUS_RESOURCE_WITH_ID = "/bus/{busDNI}/{busPasswd}";
	...
	public static final String C2DM_REGISTRATION_RESOURCE_WITH_UUID = "/c2dm-registration/{deviceUUID}";
